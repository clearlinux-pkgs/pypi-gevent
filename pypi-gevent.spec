...
Source0  : https://files.pythonhosted.org/packages/27/24/a3a7b713acfcf1177207f49ec25c665123f8972f42bee641bcc9f32961f4/gevent-24.2.1.tar.gz
...
%prep
%setup -q -n gevent-24.2.1
cd %{_builddir}/gevent-24.2.1
pushd ..
cp -a gevent-24.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707925808
...
cp %{_builddir}/gevent-%{version}/deps/c-ares/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-gevent/12127d9b9e698989a5b23087aa7c39f5e6eb264e || :
...
/usr/share/package-licenses/pypi-gevent/12127d9b9e698989a5b23087aa7c39f5e6eb264e
