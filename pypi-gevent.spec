...
Source0  : https://files.pythonhosted.org/packages/97/5e/be2ac96fe2e6d5ad40c0ed5cf83c07ce6a74b9a5a1f0422e8b5d9225c865/gevent-22.10.1.tar.gz
...
%prep
%setup -q -n gevent-22.10.1
cd %{_builddir}/gevent-22.10.1
pushd ..
cp -a gevent-22.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665850471
