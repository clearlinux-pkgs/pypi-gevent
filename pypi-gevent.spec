...
Version  : 22.8.0
Release  : 74
URL      : https://files.pythonhosted.org/packages/48/4b/dd44b36dab6a534c2af4aceb829d9977f983ff40a6a0d4217d2533801635/gevent-22.8.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/48/4b/dd44b36dab6a534c2af4aceb829d9977f983ff40a6a0d4217d2533801635/gevent-22.8.0.tar.gz
...
%prep
%setup -q -n gevent-22.8.0
cd %{_builddir}/gevent-22.8.0
pushd ..
cp -a gevent-22.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665418867
...
cp %{_builddir}/gevent-%{version}/deps/libuv/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gevent/848f7398f89046426a7ba23cb56cd3c93c030c64 || :
